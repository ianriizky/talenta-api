 ...
 * @method \Illuminate\Http\Client\Response postEmployeeInformalEducation(array $data = [], string|resource|null $file = null) Create "/employee/informal-education/create" POST request to the Talenta api.
