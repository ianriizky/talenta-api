 ...
 * @method static \Illuminate\Http\Client\Response postEmployeeInformalEducation(array $data = [], array<string|resource>|null $files = null) Create "/employee/informal-education/create" POST request to the Talenta api.
