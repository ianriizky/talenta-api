...
2. Create your issue [here](https://github.com/ianriizky/talenta-api/issues). Please don't create any PR (Pull Request) without issue to prevent overlapping PR.
